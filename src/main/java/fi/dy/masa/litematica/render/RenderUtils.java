...
public class RenderUtils
{
    ...
    public static void renderBlockOutlineOverlapping(BlockPos pos, float expand, float lineWidth,
            Color4f color1, Color4f color2, Color4f color3, PoseStack matrices, Minecraft mc)
    {
        Vec3 cameraPos = mc.gameRenderer.getMainCamera().getPosition();
        final double dx = cameraPos.x;
        final double dy = cameraPos.y;
    ...
    public static int renderInventoryOverlays(BlockInfoAlignment align, int offY, Level worldSchematic, Level worldClient, BlockPos pos, Minecraft mc)
    {
    ...
    public static int renderInventoryOverlay(BlockInfoAlignment align, LeftRight side, int offY,
            Container inv, InventoryRenderType type, InventoryProperties props, Minecraft mc)
    {
        int xInv = 0;
        int yInv = 0;
